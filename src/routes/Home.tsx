    ...
    <section className="p-6 max-w-6xl mx-auto" dir="rtl">
      ...
      {search.trim() && (
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {filtered.map((s) => {
            ...
            <article key={s.id} className="relative rounded-2xl border bg-white overflow-hidden shadow-sm">
              ...
              {s.image_url ? (
                ...
                <div className="w-full h-40 bg-gray-100 grid place-items-center text-gray-400">אין תמונה</div>
              )}
          ...
          {filtered.length === 0 && <p className="text-gray-500">לא נמצאו סיפורים</p>}
        </div>
      )}
